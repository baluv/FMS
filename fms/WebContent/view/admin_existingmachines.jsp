		        ...
		        <table id="existingmachine" class="display">
		            ...
		            <tbody>
						  ...
						  <tr style="cursor:pointer" onmouseover="this.background='#C0C0C0'" ">
						   ...
						   <td><a href="adminupdateMachine.html?itassetid=${item.itassetid}&machinetype=${item.machinetype}&machine=${item.machine}&roomNumber=${item.roomNumber}&description=${item.description}">Update</a></td> 
						   <td><a href="admindeleteMachine.html?itassetid=${item.itassetid}&organization=${organization}" onclick="return confirm('Are you sure you want to delete?')">Delete</a></td> 
						 </tr>
						  </c:forEach>
		            </tbody>
		        </table>
