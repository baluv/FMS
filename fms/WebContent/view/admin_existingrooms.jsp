		        ...
		        <table id="existingroom" class="display">
		            ...
		            <tbody>
						  ...
						  <tr style="cursor:pointer" onmouseover="this.background='#C0C0C0'" ">
						    ...
						    <td><a href="adminupdateRoom.html?generalassetid=${item.generalassetid}&roomNumber=${item.roomNumber}">Update</a></td>
						     <td><a href="admindeleteRoom.html?generalassetid=${item.generalassetid}&organization=${organization}" onclick="return confirm('Are you sure you want to delete?')">Delete</a></td>
