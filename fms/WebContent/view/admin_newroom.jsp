...
<c:url var="saveadminNewRoomURL" value="/complaints/saveadminnewroom.html" />
<form:form action="${saveadminNewRoomURL}" method="post"
	...
	<th bgcolor="#E4E6F5" class="rounded-left">&nbsp;</th>
		<th bgcolor="#E4E6F5" class="rounded-right">Enter Room Number</th></tr></thead>
		<tbody>
		<tr>
