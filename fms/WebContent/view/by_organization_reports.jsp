...
<c:url var="complaintsbyorganizationURL"
	value="/complaints/complaintsbyorganization.html" /> 
	<form action="${complaintsbyorganizationURL}" method="post" id="pdfreport" target="_blank">
...
<th	scope="col" class="rounded-left">&nbsp;</th>
	...
	<td align="right">Organization <font color="red">*</font></td><td>
		...
		<tr>
			...
			<tr><td align="right">Month  <font color="red">*</font></td>
			...
			<tr><td align="right">
			Year  <font color="red">*</font></td><td>
			<select name="year">
				<option value="none">----------</option>
