...
<c:url var="savequantityUrl" value="/complaints/savequantity.html" />
<form:form action="${savequantityUrl}" method="post"
	commandName="inwardquantityForm" id="inwardForm">
	...
	<th bgcolor="#E4E6F5" class="rounded-left">&nbsp;</th>
		<th bgcolor="#E4E6F5" class="rounded-right">Enter Inward Quqntity</th></tr></thead>
		<tbody>
		
		<tr>
			<td align="right">Id<font color="red" >*</font></td>
			<td><form:input path="inwardid" readonly="true" value="${id}"/></td>
		</tr>
		<tr>
