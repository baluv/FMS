		        ...
		        <table id="quantitydetails" class="display">
		            ...
		            <tbody>
						  ...
						  <tr style="cursor:pointer" onmouseover="this.background='#C0C0C0'" >
						    ...
						    <td><a href="updateinwardnonreturnablequantity.html?id=${item.id}&itemname=${item.itemname}&quantity=${item.quantity}">Edit</a></td>
						    <td><a href="deleteinwardnonreturnablequantity.html?id=${item.id}" onclick="return confirm('Are you sure you want to delete?')">Delete</a></td>
