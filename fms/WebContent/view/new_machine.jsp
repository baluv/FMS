...
<c:url var="saveNewMachineURL" value="/complaints/savenewmachine.html" />
<form:form action="${saveNewMachineURL}" method="post"
	commandName="newMachineForm" id="AssetForm">
    ...
    <tbody>
		...
		<tr>
			<td align="right">Room No <font color="red">*</font></td>
