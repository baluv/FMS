	...
	<div id="container1">
		<div id="page1">
			...
			<div
				...
				<c:url var="saveVehicleURL" value="/complaints/saveVehicle.html" />
				<form:form action="${saveVehicleURL}" method="post"
					commandName="vehicleForm" id="newvehicle">

					<table cellpadding="10%" cellspacing="10%" id="rounded-corner">
					<thead>
						<tr>
							<th scope="col" class="rounded-left">&nbsp;</th>
							<th scope="col" class="rounded-right">New vehicle details Form</th>
						</tr>
                    </thead>
                    <tbody>
						<tr>
