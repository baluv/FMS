...
<c:url var="orgupdateComplaintURL" value="/complaints/saveOrgUpadateComplaint.html" />
<form:form action="${orgupdateComplaintURL}" method="post"
	...
	<th scope="col" class="rounded-left">&nbsp;</th>
		...
		<tbody>
		<tr><td align="right">Complaint Id</td><td><form:input path="complaintId" readonly="true"/></td></tr>
		<tr>
		...
		<tr><td align="right">Assigned To<font color="red">*</font></td><td><form:input path="assignedto"></form:input></td></tr>
