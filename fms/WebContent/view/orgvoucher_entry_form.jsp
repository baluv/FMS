...
<c:url var="saveComplaintVoucherURL"
	value="/complaints/saveOrgVoucher.html" /> <form:form
	action="${saveComplaintVoucherURL}" method="post"
	...
	<thead>
		...
		<th scope="col" class="rounded-left">&nbsp;</th>
			<th scope="col" class="rounded-right">Fill The Details For Complaint Voucher</th>
		</tr>
		</thead>
		<tbody>
		<tr>
		...
		<tr>
			<td align="right">Towards <font color="red">*</font></td>
