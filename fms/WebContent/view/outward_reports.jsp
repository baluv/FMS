...
<c:url var="getOutwardReportURL" value="/complaints/getoutwardreport.html" />
<form:form action="${getOutwardReportURL}" method="post"
	commandName="outwardForm" id="MaterialForm"  target="_blank">
	<input type="hidden" name="organization" value="${organization}">
	<table cellpadding="10%" cellspacing="10%" id="rounded-corner">
	<thead>
	<tr>
	<th bgcolor="#E4E6F5" class="rounded-left">&nbsp;</th>
		<th bgcolor="#E4E6F5" class="rounded-right">Enter OutWard NonReturnable Details</th></tr></thead>
		<tbody>
		<tr>
			<td align="right">Choose Outward <font color="red">*</font></td>
