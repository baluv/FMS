...
<c:url var="saveaOutwarURL" value="/complaints/saveoutward.html" />
<form:form action="${saveaOutwarURL}" method="post"
	commandName="outwardForm" id="outwardForm">
	<input type="hidden" name="organization" value="${organization}">
	<table cellpadding="10%" cellspacing="10%" id="rounded-corner">
	<thead>
	<tr>
	<th bgcolor="#E4E6F5" class="rounded-left">&nbsp;</th>
		<th bgcolor="#E4E6F5" class="rounded-right">Enter Outward  Details</th></tr></thead>
		<tbody>
		<tr><td align="right">Choose Outward <font color="red">*</font></td>
		<td><form:select path="type">
		<form:option value="none" >---select---</form:option>
		<form:option value="Returnable" label="Returnable"></form:option>
		<form:option value="Non-Returnable" label="Non-Returnable"></form:option>
