...
<c:url var="roomhistorycomplaintreportURL"
	value="/complaints/roomhistorycomplaintreport.html" /> 
	<form action="${roomhistorycomplaintreportURL}" method="post" id="pdfreport" target="_blank">
	<table cellpadding="6%" cellspacing="6%" id="rounded-corner" >
	<thead>
	<tr>
	<th scope="col" class="rounded-left">&nbsp;</th>
		<th scope="col" class="rounded-right">Choose Following Details To Room Complaint History Report</th></tr>
	<tr>
	</thead>
	<tbody>
	<tr>
	<td align="right">Choose Organization <font color="red">*</font></td>
	<td>
