...
<c:url var="updateinwardquantityUrl" value="/complaints/inwardnonreturnablequantityupdated.html" />
<form:form action="${updateinwardquantityUrl}" method="post"
	commandName="updateinwardnonreturnablequantityForm" id="inwardForm">
