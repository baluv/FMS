...
<c:url var="updateMachineURL" value="/complaints/machineUpdated.html" />
<form:form action="${updateMachineURL}" method="post"
	...
	<table cellpadding="10%" cellspacing="10%" id="rounded-corner" align="center"><thead><tr>
		...
		<th scope="col" class="rounded-right">Update Machine Details</th></tr></thead>
