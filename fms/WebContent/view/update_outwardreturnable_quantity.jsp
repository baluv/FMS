...
<c:url var="updateoutwardreturnablequantityUrl" value="/complaints/outwardreturnablequantityupdated.html" />
<form:form action="${updateoutwardreturnablequantityUrl}" method="post"
	commandName="updateoutwardreturnablequantity" id="inwardForm">
