...
<html>
    ...
    <link href="../view/media/dataTables/demo_page.css" rel="stylesheet" type="text/css" />
        ...
        $(document).ready(function () {
            $("#vehicleservicedetails").dataTable({
    ...
    <div id="dt_example">
        <div id="container">
            <div id="demo_jui">
		        <table id="vehicleservicedetails" class="display">
		            <thead>
		                <tr>
		                	<th>Service Id</th>
		                    <th>Service Date</th>
		            ...
		            <tbody>
		          		<c:forEach items="${vehicleserviceList}" var="item">
						  <tr style="cursor:pointer" onmouseover="this.background='#C0C0C0'" ">
						    <td><c:out value="${item.serviceid}"></c:out></td>
						    <td><c:out value="${item.servicedate}"></c:out></td>
