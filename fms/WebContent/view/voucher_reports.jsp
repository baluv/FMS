...
<c:url var="vouchersreportsURL"
	value="/complaints/voucherreport.html" /> 
	<form action="${vouchersreportsURL}" method="post" id="pdfreport" target="_blank">
	<table cellpadding="4%" cellspacing="4%" id="rounded-corner" >
	<thead>
	<tr>
	<th scope="col" class="rounded-left">&nbsp;</th>
		<th scope="col" class="rounded-right">Choose Month And Year For Monthly Report</th></tr></thead>
		<tbody>
		<tr>
